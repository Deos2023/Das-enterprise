      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 text-center text-white pt-20">
        ...
        >
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 leading-tight">
            24×7 Oxygen & Critical Care
            <br />
            <span className="text-white/90">Equipment on Rent in Kolkata</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl lg:text-2xl text-white/80 mb-8 max-w-3xl mx-auto">
            Trusted Oxygen Equipment Supplier | ICU Setup at Home
            <br />
          ...
          >
            <a href="tel:+919038234917" className="btn-hero-primary">
